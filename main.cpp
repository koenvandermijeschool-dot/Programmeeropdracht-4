            ...
            while (spelActief) {
                ...
                switch (keuze) {
                    ...
                    case 'd': {
                        ...
                        bord.pushSnapshot(); // snapshot voor undo
                    ...
                    case 'u': {
                        if (bord.undo()) {
                            cout << "Laatste zet ongedaan gemaakt." << endl;
                            bord.afdrukken();
                        } else {
                            cout << "Geen zet om ongedaan te maken!" << endl;
                        }
                        break;
                    }
